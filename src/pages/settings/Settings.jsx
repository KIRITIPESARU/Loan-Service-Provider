            ...
            {activeTab === "profile" && (
              <div className="space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input className="w-full px-4 py-2 border border-gray-300 rounded-lg"
                        type="text" defaultValue={user?.fullName}
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Email</label>
                      <input className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100"
                  ...
                  <div className="mt-6">
                    <button className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Update Profile</button>
                  </div>
                </div>
              </div>
            )}
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <button className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-100">Regenerate</button>
                    </div>
                    <div className="flex items-center justify-between">
                      <div>
                      ...
                      <button className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Generate</button>
                    </div>
                  </div>
