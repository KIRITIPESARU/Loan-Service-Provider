      ...
      <div className="relative p-6 md:p-8 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-slate-800">Welcome back, {userName}<span className="inline-block ml-2 animate-pulse">🎉</span></h1>
          </div>
          <p className="text-slate-500 text-base md:text-lg max-w-xl leading-relaxed">Access your loans, track applications, and manage repayments securely from one place.</p>
          <div className="flex flex-wrap gap-4 mt-6">
            ...
            <button onClick={() => navigate('/loans-summary')}
