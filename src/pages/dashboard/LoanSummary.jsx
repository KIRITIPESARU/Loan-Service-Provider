  ...
  return (
    <div className="bg-white rounded-2xl shadow-md border border-slate-100 overflow-hidden">
      <div className="px-6 py-5 border-b border-slate-100 flex justify-between items-center">
        ...
        {data && (
          <button 
            onClick={() => window.location.href='/loans-summary'} 
              ...
              <div className="mb-4">
                ...
                <div className="mt-3 text-sm text-slate-600 grid grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-3">
                  ...
                  <p className="flex flex-col">
                    ...
                    <span className="inline-flex"><span className="font-semibold text-emerald-700 bg-emerald-50 border border-emerald-100 px-2.5 py-0.5 rounded-full text-xs">{loan.status}</span></span>
                  </p>
                </div>
              </div>
