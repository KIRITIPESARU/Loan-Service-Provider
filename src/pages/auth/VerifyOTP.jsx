    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Enter the 6-digit code sent to <strong>{email}</strong></p>
        </div>
        ...
        <Button onClick={handleSubmit} loading={loading} className="w-full mb-4">Verify & Continue</Button>
        <div className="text-center">
          <p className="text-gray-600">
            Didn't receive the code?
            <button onClick={handleResend} disabled={timer > 0} className={`font-medium ${
