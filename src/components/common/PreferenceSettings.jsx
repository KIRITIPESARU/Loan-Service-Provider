...
const PreferenceSettings = () => {
  const [preferences, setPreferences] = useState({theme: 'light', language: 'English', timezone: 'IST (UTC+5:30)', currency: 'INR (₹)'});
  const handleSave = () => { alert('User preferences saved successfully!'); };
  return (
    <div className="space-y-6">
      ...
      <div className="pt-4 border-t border-gray-100 mt-6"><Button onClick={handleSave}>Save Preferences</Button></div>
    </div>
  );
};
