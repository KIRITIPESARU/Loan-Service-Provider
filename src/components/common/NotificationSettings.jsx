      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 rounded-xl p-4 space-y-4 border border-gray-100">
          <label className="flex items-center justify-between cursor-pointer">
            ...
            <input type="checkbox" checked={settings.emailEMI} onChange={() => handleToggle('emailEMI')}
          ...
          <label className="flex items-center justify-between cursor-pointer">
            ...
            <input type="checkbox" checked={settings.emailOffers} onChange={() => handleToggle('emailOffers')}
              className="w-5 h-5 rounded text-blue-600 focus:ring-blue-500" />
          </label>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 rounded-xl p-4 space-y-4 border border-gray-100">
          <label className="flex items-center justify-between cursor-pointer">
            ...
            <input type="checkbox" checked={settings.smsEMI} onChange={() => handleToggle('smsEMI')}
              className="w-5 h-5 rounded text-blue-600 focus:ring-blue-500"/>
          </label>
          <label className="flex items-center justify-between cursor-pointer">
            <div>
            ...
            <input type="checkbox" checked={settings.smsOffers} onChange={() => handleToggle('smsOffers')}
              className="w-5 h-5 rounded text-blue-600 focus:ring-blue-500"/>
          </label>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 rounded-xl p-4 space-y-4 border border-gray-100">
          <label className="flex items-center justify-between cursor-pointer">
            ...
            <input type="checkbox" checked={settings.pushEMI} onChange={() => handleToggle('pushEMI')}
              className="w-5 h-5 rounded text-blue-600 focus:ring-blue-500"/>
          </label>
          <label className="flex items-center justify-between cursor-pointer">
            <div>
            ...
            <input type="checkbox" checked={settings.pushActivity} onChange={() => handleToggle('pushActivity')}
              className="w-5 h-5 rounded text-blue-600 focus:ring-blue-500"/>
          </label>
        </div>
      </div>
