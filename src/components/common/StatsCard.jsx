    ...
    <div className="bg-white rounded-2xl p-5 shadow-md border border-slate-100 card-hover transition-all">
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-3xl md:text-4xl font-bold text-slate-800 mt-2 tracking-tight">{value}</p>
        </div>
        <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${gradient} flex items-center justify-center`}>{icon}</div>
      </div>
      {(trend || subtitle) && (
